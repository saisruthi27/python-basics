...
# #transforming code into idomatic python
#   replace traditional index manipulation with python core looping idomatic
...
# ###print two coloumns
# 
# ###print large value from custId column
# 
# ###print least value from custId column
# 
# ###print average of custId column--sum(li)/len(li)
# 
# 

# ###numpy-working with multidimensional array
# numpy arrays is a bit like python list
# numpy array is a datastructure with numpynib
...
array = np.array(li)
print(array)#convert thelist into array using np.array()a1=
